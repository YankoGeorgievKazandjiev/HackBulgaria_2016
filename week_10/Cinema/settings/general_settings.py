...
USERNAME_EXIST = "Username EXISTS. Please select another one:"
...
INITIAL_GREETING = '''Hello, user! You have the following options:
"1:Show movies"
...
HELP = "Chose some option from menue!!!"
